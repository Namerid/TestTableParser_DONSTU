...
#   группа, ФИО, дисциплина, полученный балл, время начала и конца попытки.
POINTS_COLUMNS = {
    "группа": "A",
    "ФИО": "B",
    "дисциплина": "C",
...
# Столбцы I и J ("Прошли тест", "Средний балл") рассчитываются по данным из файлов баллов.
OUTPUT_COLUMNS = {
    "Учебный план": "A",
    "Факультет группы": "B",
    ...
    "Вид занятий": "G",
    "Преподаватель": "H",
    "Прошли тест": "I",       # Количество студентов, сдавших тест (из файла баллов)
...
def processing(
    ...
    Параметры:
        ...
        output_passed_header_name  — название столбца "Прошли тест"
